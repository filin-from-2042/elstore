    ...
    <div class="col-sm-6">
      ...
      <legend><?php echo $text_your_details; ?></legend>
        ...
        <div class="form-group">
          ...
          <input type="text" name="firstname" value="" class="form-control" id="input-payment-firstname" placeholder="Фамилия"/>
        </div>

        <div class="form-group">
            <label class="control-label" for="input-payment-lastname"><span class="required">*</span> <?php echo $entry_lastname; ?></label>
            <input type="text" name="lastname" value="" class="form-control" id="input-payment-lastname" placeholder="Имя" />
        </div>

        <div class="form-group">
            <label class="control-label" for="input-payment-email"><span class="required">*</span> <?php echo $entry_email; ?></label>
            <input type="text" name="email" value="" class="form-control" id="input-payment-email" placeholder="E-mail"  />
        </div>

        <div class="form-group">
          <label class="control-label" for="input-payment-telephone"><span class="required">*</span> <?php echo $entry_telephone; ?></label>
          <input type="text" name="telephone" value="" class="form-control" id="input-payment-telephone" placeholder="Телефон"  />
        </div>

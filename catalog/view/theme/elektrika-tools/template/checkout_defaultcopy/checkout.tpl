...
<div class="container">
    ...
    <div class="row">
        ...
        <div id="content" class="<?=$class?>"><?php echo $content_top; ?>
          ...
          <div class="checkout panel-group">
            <div id="checkout" class="panel panel-default">
              <div class="checkout-heading panel-heading"><h4 class="panel-title"><?php echo $text_checkout_option; ?></h4></div>
              <div class="checkout-content panel-body panel-collapse collapse"></div>
            </div>

            <?php if (!$logged) { ?>
            <div id="payment-address" class="panel panel-default">
              <div class="checkout-heading panel-heading"><h4 class="panel-title"><?php echo $text_checkout_account; ?></h4></div>
              <div class="checkout-content panel-body panel-collapse collapse"></div>
            </div>
            <?php } else { ?>
            <div id="payment-address" class="panel panel-default">
              <div class="checkout-heading panel-heading"><h4 class="panel-title"><?php echo $text_checkout_payment_address; ?></h4></div>
              <div class="checkout-content panel-body panel-collapse collapse"></div>
            </div>
            <?php } ?>
            <?php if ($shipping_required) { ?>
            <div id="shipping-address" class="panel panel-default">
              <div class="checkout-heading panel-heading"><h4 class="panel-title"><?php echo $text_checkout_shipping_address; ?></h4></div>
              <div class="checkout-content panel-body panel-collapse collapse"></div>
            </div>
            <div id="shipping-method" class="panel panel-default">
              <div class="checkout-heading panel-heading"><h4 class="panel-title"><?php echo $text_checkout_shipping_method; ?></h4></div>
              <div class="checkout-content panel-body panel-collapse collapse"></div>
            </div>
            <?php } ?>
            <div id="payment-method" class="panel panel-default">
              <div class="checkout-heading panel-heading"><h4 class="panel-title"><?php echo $text_checkout_payment_method; ?></h4></div>
              <div class="checkout-content panel-body panel-collapse collapse"></div>
            </div>
            <div id="confirm" class="panel panel-default">
              <div class="checkout-heading panel-heading"><h4 class="panel-title"><?php echo $text_checkout_confirm; ?></h4></div>
              <div class="checkout-content panel-body panel-collapse collapse"></div>
            </div>
          </div>
...
$('#checkout').on('change','.checkout-content input[name=\'account\']', function() {
	if ($(this).attr('value') == 'register') {
		$('#payment-address .checkout-heading h4').html('<?php echo $text_checkout_account; ?>');
	} else {
		$('#payment-address .checkout-heading h4').html('<?php echo $text_checkout_payment_address; ?>');
	}
});

$('.checkout-heading').on('click', 'span', function() {
...
// Checkout
$('#checkout').on('click','#button-account', function() {
	$.ajax({
		...
		success: function(html) {
			...
			$('.checkout-heading span').remove();
				
			$('#checkout .checkout-heading').append('<span class="btn btn-primary"><?php echo $text_modify; ?></span>');
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
		}

                    ...
                    <div class="radio">
                        <label>
                            <?php if (!isset($code)) { ?>
                                ...
                                <input type="radio" name="code" value="<?php echo $payment_option['code']; ?>" checked />
                            <?php } else { ?>
                                <input type="radio" name="code" value="<?php echo $payment_option['code']; ?>" />
                            <?php } ?>
                            <?php echo $payment_option['title']; ?>
                            <?php if ($iso_code_3 == 'NLD') { ?>
                                <img src="catalog/view/<?php echo $this->config->get('config_template'); ?>/default/image/klarna_nld_banner.png" />
                            <?php } ?>
                        </label>
                    </div>
                <?php } ?>
